...
public class FPenjualan extends javax.swing.JFrame {
    ...
    private void load_data() {
        Object header[]={"NOTA","NAMA BARANG","NAMA USER","TGL PENJUALAN","JUMLAH BARANG JUAL","TOTAL JUAL"};
        DefaultTableModel data= new DefaultTableModel(null,header);
        TPenjualan.setModel(data);
        String sql="SELECT nota,tbl_barang.nama_barang,tbl_user.NAMA_USER, tgl_penjualan, jmlh_barang_jual,total_jual "
                + "FROM tbl_penjualan INNER JOIN tbl_barang ON tbl_penjualan.kd_barang=tbl_barang.kd_barang "
                + "INNER JOIN tbl_user ON tbl_penjualan.id_user=tbl_user.ID_USER;";
        try {
    ...
    private void IDOtomatis() {
        try {
            st=koneksi.con.createStatement();
            String sql="SELECT * FROM tbl_penjualan order by nota desc";
            rs=st.executeQuery(sql);
            if(rs.next()) {
                String ID=rs.getString("nota");
                ...
                INota.setText(Nol + NO);
                INota.setEnabled(false);
            }
            else {
                INota.setText("0001");
            }
    ...
    public void input_data() {
        try {
            ...
            String sql="INSERT INTO tbl_penjualan values('"+INota.getText()
            +"','"+kd
            +"','"+id
            +"','"+ITanggal.getText()
            +"','"+IJumlah.getText()
            ...
            +"')";
            st.execute(sql);
            JOptionPane.showMessageDialog(null, "Data Penjualan Berhasil Dimasukan");
        }
        catch(Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    private void Edit() {
        ...
        //Mengambil ComboBox Barang
            ...
            //Query Input ke Tabel USer
            String sql_edit="UPDATE tbl_penjualan SET nota='"+INota.getText()
                    +"',kd_barang='"+kd
                    +"',id_user='"+id
                    +"',tgl_penjualan='"+ITanggal.getText()
                    +"',jmlh_barang_jual='"+IJumlah.getText()
                    +"',total_jual='"+ITotal.getText()
                    +"' WHERE nota='"+INota.getText()+"'";
    ...
    private void Hapus() {
        try {
            st = koneksi.con.createStatement();
            String sql_delete="Delete FROM tbl_penjualan WHERE nota='"+INota.getText()+"'";
    ...
    private void initComponents() {
        ...
        INota = new javax.swing.JTextField();
        ...
        jLabel7.setText("JUMLAH BARANG JUAL");
        ...
        jLabel9.setText("DATA PENJUALAN APLIKASI KASIR");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(31, 31, 31)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(INota, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(INota, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private javax.swing.JTextField INota;
